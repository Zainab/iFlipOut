package com.out.veritra.adapters;
...
public class YoutubeAdapter extends BaseAdapter { 
  ...
  public YoutubeAdapter(Activity context, List<Youtube> channels) {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    final Youtube book = channels.get(position);
    holder.title.setText(book.getTitle());
    holder.pageCount.setText(book.getLink());
    return convertView;
  }
